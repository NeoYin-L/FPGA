...
// cho man hinh (chu so 0-9, dau cham, dau bang, chu U/V/R/o/h, dau gach
// ngang, khoang trang) - khong phai bang ASCII day du, de tiet kiem tai
// nguyen va don gian hoa.
//
...
module font5x7_rom (
    ...
    // Moi ky tu dong goi thanh 1 vector 40-bit = 5 cot x 8 bit, cot 0 o vi
    // tri cao nhat (bit [39:32]) ... cot 4 o thap nhat (bit [7:0]), tra ra
    // qua ham lay 8 bit tuong ung voi col_idx.
    logic [39:0] glyph;
    ...
    // col_idx=0 -> byte cao nhat (bit [39:32]), col_idx=4 -> byte thap nhat
    // (bit [7:0]). Dung ham lay ra tranh phai viet case rieng.
